...
-   Supports both monthly and daily input data (with configurable days per year for daily analysis).
...
Usage:
    ...
    # Analyze a daily file with a 5-year window (defaulting to 252 days/year)
    python data_metrics.py -n 5 -f my_daily_data.xlsx -d
