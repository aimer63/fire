...
def plot_bank_account_trajectories_real(results_df, bank_account_plot_indices, real_bank_lower_bound, filename="bank_account_trajectories_real.png"):
    """
...
def plot_bank_account_trajectories_nominal(results_df, bank_account_plot_indices, real_bank_lower_bound, filename="bank_account_trajectories_nominal.png"):
    """
    ...
    plt.axhline(y=real_bank_lower_bound, color='r', linestyle='--', label='Real Bank Lower Bound (Nominal Reference)')
