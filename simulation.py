...
def run_single_fire_simulation(
    ...
    annual_inflations_sequence = np.random.lognormal(
        mu_log_pi, sigma_log_pi, t_ret_years
    ) - 1
    ...
    for current_month_idx in range(t_ret_months):
        ...
        for i, (nominal_contribution_amount, contribution_year_idx) in enumerate(c_planned):
        ...
        if c_real_monthly_initial > 0:
            nominal_monthly_contribution = (
                c_real_monthly_initial * cumulative_inflation_factors_annual[current_year_idx]
            )
        ...
        nominal_monthly_expenses = (
            x_real_monthly_initial * cumulative_inflation_factors_annual[current_year_idx]
        )
        ...
        for i, (nominal_extra_expense_amount, expense_year_idx) in (
                enumerate(local_planned_extra_expenses)):
        ...
        if (current_year_idx == rebalancing_year_idx
            ...
            if h0_real_cost > 0:
                nominal_house_cost = (
                    h0_real_cost * cumulative_inflation_factors_annual[rebalancing_year_idx]
                )
                liquid_assets_pre_house = (
                    current_str_value + current_bonds_value +
                    current_stocks_value + current_fun_value
                )
            ...
            if h0_real_cost > 0:
                ...
                if sum_liquid_p2_weights == 0:
                    ...
                    normalized_weights_phase2_stocks = w_p2_stocks / sum_liquid_p2_weights
            ...
            rebalancing_allocations_real = {
                ...
                'Real Estate': rebalancing_allocations_nominal['Real Estate'] / inflation_factor
            }
